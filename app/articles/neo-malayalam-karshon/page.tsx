...
const slug = "neo-malayalam-karshon";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/articles/images/neo-malayalam-karshon/title.png",
  ...
  twitter: {
    ...
    description:
      "Hendo Academy's proposal for writing modern Malayalam in East Syriac script - supplying the letters classical Karshon lacked without asking for new Unicode code points.",
    images: ["/articles/images/neo-malayalam-karshon/title.png"],
  },
  alternates: {
...
const html = `<img src="/articles/images/neo-malayalam-karshon/title.png" alt="Neo Malayalam Karshon - നിയോ മലയാളം കർശോൻ - ܢܝܼܝܘܿ ܡܲܠܲܝܵࡨܲܡ ܟܲܪܫܘܿܢ" class="featured-image" width="1600" height="1200">
